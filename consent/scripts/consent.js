...
function($scope, $humane, $window, $http, formService, learnMoreService, authService) {
    ...
    var steps = (window.mobile) ? mobileSteps : desktopSteps;
    document.body.className = (window.mobile) ? "mobile" : "desktop";
